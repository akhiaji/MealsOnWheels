...
////                    }
////                })
//                self.tableView.insertRows(at: [(NSIndexPath(indexes: [0,self.users.count - 1], length: 2) as IndexPath)], with: UITableViewRowAnimation.automatic)
...
//                text.addAttribute(NSForegroundColorAttributeName, value: UIColor.green, range: NSMakeRange(0, text.length))
//                cell.routeSpec = User.routes[self.objectNum]
//                cell.user = user
//                cell.emailLbl.attributedText = text
//            } else {
//                let text = NSMutableAttributedString(string: user[user.allKeys[0] as! String] as! String)
//                text.addAttribute(NSForegroundColorAttributeName, value: UIColor.red, range: NSMakeRange(0, text.length))
//                cell.routeSpec = User.routes[self.objectNum]
//                cell.user = user
//                cell.emailLbl.attributedText = text
//
